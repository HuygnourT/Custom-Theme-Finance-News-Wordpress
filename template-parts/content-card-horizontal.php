<?php
/**
 * Template Part: Post Card Horizontal - Card bài viết ngang
 * Gọi: get_template_part('template-parts/content', 'card-horizontal');
 * 
 * @package FXTradingToday
 */
?>

<article class="post-card post-card-horizontal" id="post-<?php the_ID(); ?>">
